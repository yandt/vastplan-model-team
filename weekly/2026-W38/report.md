...
- **覆盖 · 重要性加权占参与轮次（深＝独有，浅＝共同；末三列＝覆盖率/独有覆盖率/环比）**：1. DeepSeek V4.1 Flash（max）（36%）、2. DeepSeek V4.1 Flash（high）（35%）、3. Muse Spark 1.3 Contributor（30%）、4. K3 方舟 Agent Plan（27%）、5. Grok 4.6 Extra High（26%）、6. DeepSeek V4 Flash（26%）、7. GLM-5.3（25%）、8. GLM-5.3-Flash（25%）、9. Gemini 3.8 Flash（13%）、10. MiMo V2.5 Pro（8%）
...
- **覆盖 · 重要性加权占参与轮次（深＝独有，浅＝共同；末三列＝覆盖率/独有覆盖率/环比）**：1. Gemini 3.8 Flash（47%）、2. K3 方舟 Agent Plan（43%）、3. Grok 4.6 Extra High（41%）、4. GLM-5.3（27%）、5. DeepSeek V4.1 Flash（max）（25%）、6. GLM-5.3-Flash（25%）、7. DeepSeek V4 Flash（25%）、8. Muse Spark 1.3 Contributor（25%）、9. MiMo V2.5 Pro（19%）、10. DeepSeek V4.1 Flash（high）（0%）
